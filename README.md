...
[![Socket Badge](https://socket.dev/api/badge/npm/package/http-response-status-code/1.7.5)](https://socket.dev/npm/package/http-response-status-code/overview/1.7.5)
