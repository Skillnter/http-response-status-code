...
STATUS_CODES[MODULE.TOO_LONG = 122] = "Too Long";
...
STATUS_CODES[MODULE.SWITCH_PROXY = 306] = "Switch Proxy";
...
STATUS_CODES[MODULE.MISDIRECTED_REQUEST = 421] = "Misdirected Request";
...
STATUS_CODES[MODULE.TOO_EARLY = 425] = "Too Early";
STATUS_CODES[MODULE.UPGRADE_REQUIRED = 426] = "Upgrade Required";
...
STATUS_CODES[MODULE.INTERNAL_SERVER_ERROR = 500] = "Internal Server Error";
...
STATUS_CODES[MODULE.VARIANT_ALSO_NEGOTIATES = 506] = "Variant Also Negotiates";
STATUS_CODES[MODULE.INSUFFICIENT_STORAGE = 507] = "Insufficient Storage";
STATUS_CODES[MODULE.LOOP_DETECTED = 508] = "Loop Detected";
STATUS_CODES[MODULE.NOT_EXTENDED = 510] = "Not Extended";
