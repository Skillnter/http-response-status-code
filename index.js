...
MODULE.getStatusCode = function (name) {
    if (Object.prototype.hasOwnProperty.call(MODULE, "".concat(name)) &&
        typeof MODULE["".concat(name)] === "number") {
...
MODULE.getStatusName = function (code) {
    if (Object.prototype.hasOwnProperty.call(STATUS_CODES, "".concat(code))) {
        ...
        for (var i = 0; i < keys.length; i++) {
            if (MODULE[keys[parseInt("".concat(i), RADIX)]] === code) {
                return keys[parseInt("".concat(i), RADIX)];
            }
        }
    }
    else {
 ...
 */
MODULE.isInformational = function (code) {
    return (0, utils_1.checkInformational)(STATUS_CODES, code);
};
/**
...
MODULE.getInformationalCodes = function () {
    return (0, utils_1.listInformationalCodes)(STATUS_CODES);
};
/**
 ...
 * @throws {Error} If the status code does not exist.
 */
MODULE.isSuccess = function (code) {
    return (0, utils_1.checkSuccess)(STATUS_CODES, code);
};
/**
...
MODULE.getSuccessCodes = function () {
    return (0, utils_1.listSuccessCodes)(STATUS_CODES);
};
/**
 ...
 * @throws {Error} If the status code does not exist.
 */
MODULE.isRedirectional = function (code) {
    return (0, utils_1.checkRedirectional)(STATUS_CODES, code);
};
/**
...
MODULE.getRedirectionalCodes = function () {
    return (0, utils_1.listRedirectionalCodes)(STATUS_CODES);
};
/**
 ...
 * @throws {Error} If the status code does not exist.
 */
MODULE.isClientError = function (code) {
    return (0, utils_1.checkClientError)(STATUS_CODES, code);
};
/**
...
MODULE.getClientErrorCodes = function () {
    return (0, utils_1.listClientErrorCodes)(STATUS_CODES);
};
/**
 ...
 * @throws {Error} If the status code does not exist.
 */
MODULE.isServerError = function (code) {
    return (0, utils_1.checkServerError)(STATUS_CODES, code);
};
/**
...
MODULE.getServerErrorCodes = function () {
    return (0, utils_1.listServerErrorCodes)(STATUS_CODES);
};
/**
 ...
 */
MODULE.isValidStatusCode = function (code) {
    return (0, utils_1.checkValidStatusCode)(STATUS_CODES, code);
};
